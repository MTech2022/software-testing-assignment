...
/**
 * Team Members : Sandeep M(220928012) Umadevi KS(220928007) Create a new SingleGraph instance for each test case Add
 * nodes to the graph and Assert that the nodes Add an edge between the nodes & Assert that the edge
 */
